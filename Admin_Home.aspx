        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="Here you can carry out admin side operations"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/Edit Product.aspx">Edit Product</asp:LinkButton>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
