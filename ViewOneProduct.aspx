<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewOneProduct.aspx.cs" Inherits="WebApplication1.ViewOneProduct" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Image ID="Image1" runat="server" Height="322px" Width="363px" />
                </td>
                <td class="auto-style3">&nbsp;</td>
                <td class="auto-style4">&nbsp;</td>
                <td class="auto-style5">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Enter Quantity"></asp:RequiredFieldValidator>
                </td>
                <td>
